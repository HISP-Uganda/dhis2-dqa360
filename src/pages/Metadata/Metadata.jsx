...
import { DataElementManagement } from './DataElementManagement'
import { DataSetManagement } from './DataSetManagement'
import { OrganisationUnitManagement } from './OrganisationUnitManagement'
    ...
    return (
        <Box>
            <Box marginBottom="24px">
                <h1>{i18n.t('Metadata Management')}</h1>
